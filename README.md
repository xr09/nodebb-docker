...
amd64 only in CI: NodeBB's npm install under QEMU emulation turns a ~3 minute
build into 20-40. Add `linux/arm64` to `platforms` in the workflow if you need it.
